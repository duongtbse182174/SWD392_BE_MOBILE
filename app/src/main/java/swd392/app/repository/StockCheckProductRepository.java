...
public interface StockCheckProductRepository extends JpaRepository<StockCheckProduct, String> {
    ...
    Optional<StockCheckProduct> findTopByProductAndStockCheckNoteWarehouseAndStockCheckNoteStockCheckStatusOrderByStockCheckNoteDateDesc(
            Product product, Warehouse warehouse, StockCheckStatus status);
}